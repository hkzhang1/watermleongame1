...
public class FruitPanel extends JPanel{
    ...
    private Fruit apple;
        ...
        public fruitsMovementPanel() { // for other code in this class << we gotta change this name what im confusing it w the fruitmovement in initpanel

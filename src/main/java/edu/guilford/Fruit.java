...
public class Fruit {
    ...
    //constructors to initialize each fruit with the parameteres x, y (for the position), the radius of the ball, the type (so the name), the color to differentiate, and the velocity of the ball
        ...
        // Draw the fruit as a circle on the panel
            ...
            g.setColor(Color.RED);  // need to make it so that it changes colors based on type
